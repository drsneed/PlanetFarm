...
// SCITER-
    ...
    hr = CompileShaderFromFile( L"W:/Code/C++/cartel/sciter-sdk/demos.win/sciter-directx/shaders.fx", "VS", "vs_5_0", &pVSBlob );
    if( FAILED( hr ) )
    {
        MessageBox( NULL,
    ...
    hr = CompileShaderFromFile( L"W:/Code/C++/cartel/sciter-sdk/demos.win/sciter-directx/shaders.fx", "PS", "ps_5_0", &pPSBlob );
    if( FAILED( hr ) )
    {
        MessageBox( NULL,
                    L"The FX file cannot be compiled.  Please run this executable from sciter-sdk/bin folder.", L"Error", MB_OK );
